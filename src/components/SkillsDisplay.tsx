...
export const defaultSkills: Skill[] = [
  ...
  { name: "TypeScript",   level: 85, color: "hsl(211 95% 50%)",   icon: "TS", category: "frontend" },
  ...
  { name: "Three.js",     level: 65, color: "hsl(30 90% 48%)",    icon: "🔺", category: "frontend" },
  { name: "Node.js",      level: 75, color: "hsl(142 70% 38%)",   icon: "⬡",  category: "backend"  },
  { name: "REST APIs",    level: 82, color: "hsl(262 60% 55%)",   icon: "🔗", category: "backend"  },
